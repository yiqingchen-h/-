...
int velocity_PID_value(int velocity)
{
	...
	filt_velocity = a*(velocity - Mu_Biao_SuDu) + (1-a)*last_filt_velocity; //一阶速度滤波
...
//转向换
//角速度，目标角度
int ZhuanXiang_Pid_Value(short gyro_Z ,float MuBiao_Jiao)
{
	return ZKp * MuBiao_Jiao + ZKd * gyro_Z ;
}
