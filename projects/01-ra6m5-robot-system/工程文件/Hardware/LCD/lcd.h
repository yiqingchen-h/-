...
void LCD_ShowIntNumSigned(int32_t num, uint16_t x, uint16_t y, uint8_t len, uint16_t fc, uint16_t bc, uint8_t sizey);//带符号整数
void LCD_ShowFloatNumSigned(float num, uint16_t x, uint16_t y, uint8_t int_len, uint8_t dec_len, uint16_t fc, uint16_t bc, uint8_t sizey);//带符号小数
void LCD_ShowHexNumWithPrefix(uint32_t num, uint16_t x, uint16_t y, uint8_t len, uint16_t fc, uint16_t bc, uint8_t sizey);//hex显示
void LCD_ShowBinNumWithPrefix(uint32_t num, uint16_t x, uint16_t y, uint8_t len, uint16_t fc, uint16_t bc, uint8_t sizey);//二进制显示
